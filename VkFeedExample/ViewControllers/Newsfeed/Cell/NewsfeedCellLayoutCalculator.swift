...
public final class FeedCellLayoutCalculator: FeedCellLayoutCalculatorProtocol {
    ...
    public func sizes(postText: String?, photoAttachments: [FeedCellPhotoAttachmentViewModel], isFullSizedPost: Bool) -> FeedCellSizes {
...
//        }
        ...
        if let attachment = photoAttachments.first {
            ...
            if photoAttachments.count == 1 {
                ...
                let rowHeight = RowLayout.rowHeightCounter(superviewWidth: cardViewWidth, photosArray: photos) ?? 0
